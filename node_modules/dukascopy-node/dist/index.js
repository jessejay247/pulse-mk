...
var instrument_meta_data_default = {
  ...
  gbppln: {
    ...
    decimalFactor: 1e5,
    startHourForTicks: "2012-03-30T10:31:41.692Z",
...
var BufferFetcher = class {
  ...
  async fetchBuffer(url) {
    ...
    let response = new import_node_fetch.Response();
    ...
    if (shouldUseRetry) {
      ...
      while (retries <= this.retryCount && !isTrySuccess) {
        ...
        try {
          response = await (0, import_node_fetch.default)(url);
        } catch (e) {
          isCallSuccess = false;
...
var CacheManager = class {
  ...
  async readItemFromCache(key) {
    ...
    return (0, import_fs_extra.readFile)(cacheItemPath);
  }
